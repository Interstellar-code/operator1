...
export const FurnitureType = {
  ...
  PC: "pc",
  LAMP: "lamp",
  BATCAVE_PILLAR: "batcave_pillar",
  BATCAVE_CONSOLE: "batcave_console",
  BROADCAST_CONSOLE: "broadcast_console",
  SERVER_RACK: "server_rack",
  CABLE_BUNDLE: "cable_bundle",
  SIGNAL_TRANSMITTER: "signal_transmitter",
  MAINTENANCE_PANEL: "maintenance_panel",
  LOG_TERMINAL: "log_terminal",
  BROADCAST_CHAIR: "broadcast_chair",
  // Zion props
  HYDRO_POD: "hydro_pod",
  MED_STATION: "med_station",
  WEAPON_RACK: "weapon_rack",
  GENERATOR: "generator",
  TORCH_BRAZIER: "torch_brazier",
  SUPPLY_CRATE: "supply_crate",
  WATER_PIPE: "water_pipe",
  COMMS_RADIO: "comms_radio",
